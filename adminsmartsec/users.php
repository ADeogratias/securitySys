...
{
$id=$_GET['deluser'];
$sql = "update smart_security.client set isdeleted='yes' WHERE id=:id";
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                            $sql="SELECT * from smart_security.client where isdeleted='no'";
                                            $query = $dbh -> prepare($sql);
                                            $query->execute();
                                                ...
                                                foreach($results as $result)
                                                    { ?>
                                                        <tr class="odd gradeX">
                                                            ...
                                                            <td ><a href="users.php?deluser=<?php echo htmlentities($result->id);?>" onclick="return confirm('Sure you want to delete?');">Remove</a></td>
